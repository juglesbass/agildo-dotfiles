...
PageBase {
    ...
    ColumnLayout {
        ...
        ButtonRow {
            ...
            IconTextButton {
                ...
                FileDialog {
                    ...
                    title: qsTr("Selecionar uma imagem")
                    filterLabel: qsTr("Arquivos de imagem")
        ...
        WallItem {
            ...
            text: qsTr("Papel de parede em destaque")
            fillLabel: false
            onClicked: {
        ...
        StyledText {
            ...
            text: qsTr("Papéis de parede locais")
        ...
        GridLayout {
            ...
            Repeater {
                ...
                model: {
                    const list = root.fullList.slice(0, root.displayLimit);
        ...
        Loader {
            ...
            sourceComponent: StyledRect {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        Layout.alignment: Qt.AlignHCenter
                        text: qsTr("Nenhum papel de parede local encontrado")
                        color: Colours.palette.m3outline
                        font: Tokens.font.title.small
                    }
                }
