...
PageBase {
    ...
    ColumnLayout {
        ...
        ItemList {
            ...
            placeholderText: root.btEnabled ? qsTr("Nenhum dispositivo salvo") : qsTr("Bluetooth desativado")
        ...
        RowButton {
            last: true
            icon: "add"
            text: qsTr("Parear novo dispositivo")
        ...
        ToggleRow {
            ...
            first: true
            text: qsTr("Visível")
            subtext: qsTr("Permitir que dispositivos próximos encontrem este")
            disabled: !root.btEnabled
        ...
        ToggleRow {
            last: true
            text: qsTr("Pareável")
            subtext: qsTr("Permitir que dispositivos próximos pareiem com este")
            disabled: !root.btEnabled
