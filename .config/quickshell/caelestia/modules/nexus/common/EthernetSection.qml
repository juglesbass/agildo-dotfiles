    ...
    ConnectedRect {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.alignment: Qt.AlignRight
                    text: Nmcli.activeEthernet ? qsTr("Conectado") : qsTr("Desconectado")
                ...
                StyledText {
                    ...
                    text: qsTr("Uso de dados: %1").arg(Nmcli.ethernetDataUsage)
        ...
        delegate: ConnectedRect {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: ethRow.modelData.connection || ethRow.modelData.iface || qsTr("Conexão cabeada")
                        font: Tokens.font.body.medium
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: ethRow.isConnected ? ethRow.modelData.iface : qsTr("Desconectado • %1").arg(ethRow.modelData.iface)
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        EthDetail {
                            ...
                            label: qsTr("Endereço IP local")
                        }

                        EthDetail {
                            id: ethDns

                            label: qsTr("DNS primário")
                        }
                    }
                }
