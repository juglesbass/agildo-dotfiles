    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column {
                ...
                StyledText {
                    text: Weather.city || "Carregando..."
                    font: Tokens.font.body.builders.large.size(28).weight(Font.DemiBold).build()
                    color: Colours.palette.m3onSurface
                }

                StyledText {
                    text: new Date().toLocaleDateString(Qt.locale("pt_BR"), "dddd, d 'de' MMMM")
                ...
                StyledRect {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            ...
                            text: forecastItem.index === 0 ? "Hoje" : new Date(forecastItem.modelData.date).toLocaleDateString(Qt.locale("pt_BR"), "ddd").replace(".", "")
                            font: Tokens.font.body.builders.medium.weight(Font.DemiBold).build()
                            color: Colours.palette.m3primary
                        }
