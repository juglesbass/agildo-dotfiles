...
Item {
    ...
    StyledText {
        ...
        text: (Players.active?.trackTitle ?? "Sem mídia") || "Título desconhecido"
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackAlbum ?? "Sem mídia") || "Álbum desconhecido"
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackArtist ?? "Sem mídia") || "Artista desconhecido"
