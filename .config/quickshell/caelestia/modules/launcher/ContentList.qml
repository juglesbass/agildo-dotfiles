...
Item {
    ...
    Row {
        ...
        Column {
            ...
            StyledText {
                text: root.state === "wallpapers" ? "Nenhum wallpaper encontrado" : "Nenhum resultado"
                color: Colours.palette.m3onSurfaceVariant
                font: Tokens.font.body.builders.large.weight(Font.Medium).build()
            }

            StyledText {
                text: root.state === "wallpapers" && Wallpapers.list.length === 0 ? `Coloque alguns wallpapers em ${Paths.shortenHome(Paths.wallsdir)}` : "Tente buscar por outro termo"
                color: Colours.palette.m3onSurfaceVariant
