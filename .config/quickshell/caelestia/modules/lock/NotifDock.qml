...
ColumnLayout {
    ...
    StyledText {
        ...
        text: Notifs.list.length > 0 ? `${Notifs.list.length} notificaç${Notifs.list.length === 1 ? "ão" : "ões"}` : "Notificações"
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                StyledText {
                    ...
                    text: Config.lock.hideNotifs ? "Desbloqueie para ver notificações" : "Sem Notificações"
